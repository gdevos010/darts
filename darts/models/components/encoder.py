...
class EncoderLayer(nn.Module):
    ...
    def __init__(
        self, attention, d_model, d_ff=None, dropout=0.1, activation="relu", ECSP=False
    ):
        super().__init__()
        ...
        self.conv3 = nn.Conv1d(
            in_channels=d_model // 2, out_channels=d_model // 2, kernel_size=1
        )
    ...
    def forward(self, x, attention_mask=None):
        ...
        if self.csp:
            ...
            new_x, attention = self.attention(
                csp_x, csp_x, csp_x, attention_mask=attention_mask
            )
